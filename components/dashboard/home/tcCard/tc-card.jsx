...
function TcCard(props) {
  return (
    <div className="flex flex-row justify-start px-4 py-4 items-center shadow-black/10 shadow-2xl rounded-lg mt-4 select-none">
      <div className="text-7xl text-darkGold opacity-50">{props.icon}</div>
